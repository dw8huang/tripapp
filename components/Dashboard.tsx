  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-slate-50">
      ...
      <main className="flex-1 overflow-y-auto pb-24">
        ...
        {viewMode === 'people' && <PeopleView trip={trip} onUpdate={onUpdate} userName={userName} />}
      </main>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 h-20 flex items-center justify-around px-6 z-50">
        ...
        <BottomTab label="People" active={viewMode === 'people'} onClick={() => setViewMode('people')} icon={(<svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>)} />
      </nav>
    </div>
  );
};
